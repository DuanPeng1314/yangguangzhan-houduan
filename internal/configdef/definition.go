...
var AllSettings = []Definition{
	...
	{Key: constant.KeySsoEnabled, Value: "false", Comment: "是否启用 SSO 统一登录", IsPublic: false},
	{Key: constant.KeySsoSiteID, Value: "yangguangzhan", Comment: "SSO 站点 ID", IsPublic: false},
	{Key: constant.KeySsoSiteSecret, Value: "", Comment: "SSO 站点密钥", IsPublic: false},
	{Key: constant.KeySsoAuthCenterURL, Value: "https://account.dp7575.com", Comment: "SSO 认证中心地址", IsPublic: false},
