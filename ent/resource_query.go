...
func (_q *ResourceQuery) QueryItems() *ResourceItemQuery {
...
func (_q *ResourceQuery) QueryOrders() *ResourceOrderQuery {
...
func (_q *ResourceQuery) QueryAccessGrants() *ResourceAccessGrantQuery {
...
func (_q *ResourceQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *ResourceQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *ResourceQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *ResourceQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *ResourceQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *ResourceQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ResourceQuery) WithItems(opts ...func(*ResourceItemQuery)) *ResourceQuery {
	query := (&ResourceItemClient{config: _q.config}).Query()
...
func (_q *ResourceQuery) WithOrders(opts ...func(*ResourceOrderQuery)) *ResourceQuery {
	query := (&ResourceOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ResourceQuery) WithAccessGrants(opts ...func(*ResourceAccessGrantQuery)) *ResourceQuery {
	query := (&ResourceAccessGrantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(resource.FieldDeletedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Resource.Query().
//		Select(resource.FieldDeletedAt).
//		Scan(ctx, &v)
...
func (_q *ResourceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Resource, error) {
	...
	if query := _q.withItems; query != nil {
		if err := _q.loadItems(ctx, query, nodes,
			func(n *Resource) { n.Edges.Items = []*ResourceItem{} },
			func(n *Resource, e *ResourceItem) { n.Edges.Items = append(n.Edges.Items, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrders; query != nil {
		if err := _q.loadOrders(ctx, query, nodes,
			func(n *Resource) { n.Edges.Orders = []*ResourceOrder{} },
			func(n *Resource, e *ResourceOrder) { n.Edges.Orders = append(n.Edges.Orders, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAccessGrants; query != nil {
		if err := _q.loadAccessGrants(ctx, query, nodes,
			func(n *Resource) { n.Edges.AccessGrants = []*ResourceAccessGrant{} },
			func(n *Resource, e *ResourceAccessGrant) { n.Edges.AccessGrants = append(n.Edges.AccessGrants, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ResourceQuery) loadItems(ctx context.Context, query *ResourceItemQuery, nodes []*Resource, init func(*Resource), assign func(*Resource, *ResourceItem)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Resource)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(resourceitem.FieldResourceID)
	}
	query.Where(predicate.ResourceItem(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(resource.ItemsColumn), fks...))
	}))
...
func (_q *ResourceQuery) loadOrders(ctx context.Context, query *ResourceOrderQuery, nodes []*Resource, init func(*Resource), assign func(*Resource, *ResourceOrder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Resource)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(resourceorder.FieldResourceID)
	}
	query.Where(predicate.ResourceOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(resource.OrdersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ResourceQuery) loadAccessGrants(ctx context.Context, query *ResourceAccessGrantQuery, nodes []*Resource, init func(*Resource), assign func(*Resource, *ResourceAccessGrant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uint]*Resource)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(resourceaccessgrant.FieldResourceID)
	}
	query.Where(predicate.ResourceAccessGrant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(resource.AccessGrantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ResourceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(resource.Table, resource.Columns, sqlgraph.NewFieldSpec(resource.FieldID, field.TypeUint))
	_spec.From = _q.sql
