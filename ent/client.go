...
func (c *Client) init() {
	...
	c.ArticlePayment = NewArticlePaymentClient(c.config)
	c.ArticlePurchase = NewArticlePurchaseClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		ArticlePayment:         NewArticlePaymentClient(cfg),
		ArticlePurchase:        NewArticlePurchaseClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Album, c.AlbumCategory, c.Article, c.ArticleHistory, c.ArticlePayment,
		c.ArticlePurchase, c.Comment, c.DirectLink, c.DocSeries, c.Entity, c.File,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *ArticlePaymentMutation:
		return c.ArticlePayment.mutate(ctx, m)
	case *ArticlePurchaseMutation:
		return c.ArticlePurchase.mutate(ctx, m)
...
func (c *AlbumClient) QueryCategory(a *Album) *AlbumCategoryQuery {
...
func (c *AlbumCategoryClient) QueryAlbums(ac *AlbumCategory) *AlbumQuery {
...
func (c *ArticleClient) QueryPostTags(a *Article) *PostTagQuery {
...
func (c *ArticleClient) QueryPostCategories(a *Article) *PostCategoryQuery {
...
func (c *ArticleClient) QueryHistories(a *Article) *ArticleHistoryQuery {
...
func (c *ArticleClient) QueryDocSeries(a *Article) *DocSeriesQuery {
...
// ArticlePaymentClient is a client for the ArticlePayment schema.
type ArticlePaymentClient struct {
	config
}

// NewArticlePaymentClient returns a client for the ArticlePayment from the given config.
func NewArticlePaymentClient(c config) *ArticlePaymentClient {
	return &ArticlePaymentClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `articlepayment.Hooks(f(g(h())))`.
func (c *ArticlePaymentClient) Use(hooks ...Hook) {
	c.hooks.ArticlePayment = append(c.hooks.ArticlePayment, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `articlepayment.Intercept(f(g(h())))`.
func (c *ArticlePaymentClient) Intercept(interceptors ...Interceptor) {
	c.inters.ArticlePayment = append(c.inters.ArticlePayment, interceptors...)
}

// Create returns a builder for creating a ArticlePayment entity.
func (c *ArticlePaymentClient) Create() *ArticlePaymentCreate {
	mutation := newArticlePaymentMutation(c.config, OpCreate)
	return &ArticlePaymentCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ArticlePayment entities.
func (c *ArticlePaymentClient) CreateBulk(builders ...*ArticlePaymentCreate) *ArticlePaymentCreateBulk {
	return &ArticlePaymentCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ArticlePaymentClient) MapCreateBulk(slice any, setFunc func(*ArticlePaymentCreate, int)) *ArticlePaymentCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ArticlePaymentCreateBulk{err: fmt.Errorf("calling to ArticlePaymentClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ArticlePaymentCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ArticlePayment.
func (c *ArticlePaymentClient) Update() *ArticlePaymentUpdate {
	mutation := newArticlePaymentMutation(c.config, OpUpdate)
	return &ArticlePaymentUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ArticlePaymentClient) UpdateOne(ap *ArticlePayment) *ArticlePaymentUpdateOne {
	mutation := newArticlePaymentMutation(c.config, OpUpdateOne, withArticlePayment(ap))
	return &ArticlePaymentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ArticlePaymentClient) UpdateOneID(id uint) *ArticlePaymentUpdateOne {
	mutation := newArticlePaymentMutation(c.config, OpUpdateOne, withArticlePaymentID(id))
	return &ArticlePaymentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ArticlePayment.
func (c *ArticlePaymentClient) Delete() *ArticlePaymentDelete {
	mutation := newArticlePaymentMutation(c.config, OpDelete)
	return &ArticlePaymentDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ArticlePaymentClient) DeleteOne(ap *ArticlePayment) *ArticlePaymentDeleteOne {
	return c.DeleteOneID(ap.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ArticlePaymentClient) DeleteOneID(id uint) *ArticlePaymentDeleteOne {
	builder := c.Delete().Where(articlepayment.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ArticlePaymentDeleteOne{builder}
}

// Query returns a query builder for ArticlePayment.
func (c *ArticlePaymentClient) Query() *ArticlePaymentQuery {
	return &ArticlePaymentQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeArticlePayment},
		inters: c.Interceptors(),
	}
}

// Get returns a ArticlePayment entity by its id.
func (c *ArticlePaymentClient) Get(ctx context.Context, id uint) (*ArticlePayment, error) {
	return c.Query().Where(articlepayment.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ArticlePaymentClient) GetX(ctx context.Context, id uint) *ArticlePayment {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ArticlePaymentClient) Hooks() []Hook {
	return c.hooks.ArticlePayment
}

// Interceptors returns the client interceptors.
func (c *ArticlePaymentClient) Interceptors() []Interceptor {
	return c.inters.ArticlePayment
}

func (c *ArticlePaymentClient) mutate(ctx context.Context, m *ArticlePaymentMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ArticlePaymentCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ArticlePaymentUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ArticlePaymentUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ArticlePaymentDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ArticlePayment mutation op: %q", m.Op())
	}
}

// ArticlePurchaseClient is a client for the ArticlePurchase schema.
type ArticlePurchaseClient struct {
	config
}

// NewArticlePurchaseClient returns a client for the ArticlePurchase from the given config.
func NewArticlePurchaseClient(c config) *ArticlePurchaseClient {
	return &ArticlePurchaseClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `articlepurchase.Hooks(f(g(h())))`.
func (c *ArticlePurchaseClient) Use(hooks ...Hook) {
	c.hooks.ArticlePurchase = append(c.hooks.ArticlePurchase, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `articlepurchase.Intercept(f(g(h())))`.
func (c *ArticlePurchaseClient) Intercept(interceptors ...Interceptor) {
	c.inters.ArticlePurchase = append(c.inters.ArticlePurchase, interceptors...)
}

// Create returns a builder for creating a ArticlePurchase entity.
func (c *ArticlePurchaseClient) Create() *ArticlePurchaseCreate {
	mutation := newArticlePurchaseMutation(c.config, OpCreate)
	return &ArticlePurchaseCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ArticlePurchase entities.
func (c *ArticlePurchaseClient) CreateBulk(builders ...*ArticlePurchaseCreate) *ArticlePurchaseCreateBulk {
	return &ArticlePurchaseCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ArticlePurchaseClient) MapCreateBulk(slice any, setFunc func(*ArticlePurchaseCreate, int)) *ArticlePurchaseCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ArticlePurchaseCreateBulk{err: fmt.Errorf("calling to ArticlePurchaseClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ArticlePurchaseCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ArticlePurchase.
func (c *ArticlePurchaseClient) Update() *ArticlePurchaseUpdate {
	mutation := newArticlePurchaseMutation(c.config, OpUpdate)
	return &ArticlePurchaseUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ArticlePurchaseClient) UpdateOne(ap *ArticlePurchase) *ArticlePurchaseUpdateOne {
	mutation := newArticlePurchaseMutation(c.config, OpUpdateOne, withArticlePurchase(ap))
	return &ArticlePurchaseUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ArticlePurchaseClient) UpdateOneID(id uint) *ArticlePurchaseUpdateOne {
	mutation := newArticlePurchaseMutation(c.config, OpUpdateOne, withArticlePurchaseID(id))
	return &ArticlePurchaseUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ArticlePurchase.
func (c *ArticlePurchaseClient) Delete() *ArticlePurchaseDelete {
	mutation := newArticlePurchaseMutation(c.config, OpDelete)
	return &ArticlePurchaseDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ArticlePurchaseClient) DeleteOne(ap *ArticlePurchase) *ArticlePurchaseDeleteOne {
	return c.DeleteOneID(ap.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ArticlePurchaseClient) DeleteOneID(id uint) *ArticlePurchaseDeleteOne {
	builder := c.Delete().Where(articlepurchase.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ArticlePurchaseDeleteOne{builder}
}

// Query returns a query builder for ArticlePurchase.
func (c *ArticlePurchaseClient) Query() *ArticlePurchaseQuery {
	return &ArticlePurchaseQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeArticlePurchase},
		inters: c.Interceptors(),
	}
}

// Get returns a ArticlePurchase entity by its id.
func (c *ArticlePurchaseClient) Get(ctx context.Context, id uint) (*ArticlePurchase, error) {
	return c.Query().Where(articlepurchase.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ArticlePurchaseClient) GetX(ctx context.Context, id uint) *ArticlePurchase {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ArticlePurchaseClient) Hooks() []Hook {
	return c.hooks.ArticlePurchase
}

// Interceptors returns the client interceptors.
func (c *ArticlePurchaseClient) Interceptors() []Interceptor {
	return c.inters.ArticlePurchase
}

func (c *ArticlePurchaseClient) mutate(ctx context.Context, m *ArticlePurchaseMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ArticlePurchaseCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ArticlePurchaseUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ArticlePurchaseUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ArticlePurchaseDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ArticlePurchase mutation op: %q", m.Op())
	}
}
...
// UpdateOne returns an update builder for the given entity.
func (c *DocSeriesClient) UpdateOne(ds *DocSeries) *DocSeriesUpdateOne {
	mutation := newDocSeriesMutation(c.config, OpUpdateOne, withDocSeries(ds))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *DocSeriesClient) DeleteOne(ds *DocSeries) *DocSeriesDeleteOne {
...
func (c *DocSeriesClient) QueryArticles(ds *DocSeries) *ArticleQuery {
	query := (&ArticleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := ds.ID
		step := sqlgraph.NewStep(
...
func (c *EntityClient) QueryFileVersions(e *Entity) *FileEntityQuery {
...
func (c *FileClient) QueryPrimaryEntity(f *File) *EntityQuery {
...
func (c *FileClient) QueryVersions(f *File) *FileEntityQuery {
	query := (&FileEntityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := f.ID
		step := sqlgraph.NewStep(
...
func (c *FileClient) QueryDirectLink(f *File) *DirectLinkQuery {
...
func (c *FileEntityClient) QueryFile(fe *FileEntity) *FileQuery {
	query := (&FileClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := fe.ID
		step := sqlgraph.NewStep(
...
func (c *FileEntityClient) QueryEntity(fe *FileEntity) *EntityQuery {
	query := (&EntityClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := fe.ID
		step := sqlgraph.NewStep(
...
func (c *LinkClient) QueryCategory(l *Link) *LinkCategoryQuery {
...
func (c *LinkClient) QueryTags(l *Link) *LinkTagQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *LinkCategoryClient) UpdateOne(lc *LinkCategory) *LinkCategoryUpdateOne {
	mutation := newLinkCategoryMutation(c.config, OpUpdateOne, withLinkCategory(lc))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *LinkCategoryClient) DeleteOne(lc *LinkCategory) *LinkCategoryDeleteOne {
...
func (c *LinkCategoryClient) QueryLinks(lc *LinkCategory) *LinkQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *LinkTagClient) UpdateOne(lt *LinkTag) *LinkTagUpdateOne {
	mutation := newLinkTagMutation(c.config, OpUpdateOne, withLinkTag(lt))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *LinkTagClient) DeleteOne(lt *LinkTag) *LinkTagDeleteOne {
...
func (c *LinkTagClient) QueryLinks(lt *LinkTag) *LinkQuery {
	query := (&LinkClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := lt.ID
		step := sqlgraph.NewStep(
...
func (c *NotificationTypeClient) QueryUserConfigs(nt *NotificationType) *UserNotificationConfigQuery {
...
func (c *PostCategoryClient) QueryArticles(pc *PostCategory) *ArticleQuery {
	query := (&ArticleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := pc.ID
		step := sqlgraph.NewStep(
...
func (c *PostTagClient) QueryArticles(pt *PostTag) *ArticleQuery {
	query := (&ArticleClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := pt.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *URLStatClient) UpdateOne(us *URLStat) *URLStatUpdateOne {
	mutation := newURLStatMutation(c.config, OpUpdateOne, withURLStat(us))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *URLStatClient) DeleteOne(us *URLStat) *URLStatDeleteOne {
...
func (c *UserClient) QueryInstalledThemes(u *User) *UserInstalledThemeQuery {
...
func (c *UserClient) QueryNotificationConfigs(u *User) *UserNotificationConfigQuery {
	query := (&UserNotificationConfigClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
...
// UpdateOne returns an update builder for the given entity.
func (c *UserInstalledThemeClient) UpdateOne(uit *UserInstalledTheme) *UserInstalledThemeUpdateOne {
	mutation := newUserInstalledThemeMutation(c.config, OpUpdateOne, withUserInstalledTheme(uit))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *UserInstalledThemeClient) DeleteOne(uit *UserInstalledTheme) *UserInstalledThemeDeleteOne {
	return c.DeleteOneID(uit.ID)
}
...
func (c *UserInstalledThemeClient) QueryUser(uit *UserInstalledTheme) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := uit.ID
		step := sqlgraph.NewStep(
		...
		fromV = sqlgraph.Neighbors(uit.driver.Dialect(), step)
		return fromV, nil
	}
	return query
}
...
// UpdateOne returns an update builder for the given entity.
func (c *UserNotificationConfigClient) UpdateOne(unc *UserNotificationConfig) *UserNotificationConfigUpdateOne {
	mutation := newUserNotificationConfigMutation(c.config, OpUpdateOne, withUserNotificationConfig(unc))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *UserNotificationConfigClient) DeleteOne(unc *UserNotificationConfig) *UserNotificationConfigDeleteOne {
	return c.DeleteOneID(unc.ID)
}
...
func (c *UserNotificationConfigClient) QueryUser(unc *UserNotificationConfig) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := unc.ID
		step := sqlgraph.NewStep(
		...
		fromV = sqlgraph.Neighbors(unc.driver.Dialect(), step)
		return fromV, nil
	}
	return query
}
...
func (c *UserNotificationConfigClient) QueryNotificationType(unc *UserNotificationConfig) *NotificationTypeQuery {
...
// UpdateOne returns an update builder for the given entity.
func (c *VisitorLogClient) UpdateOne(vl *VisitorLog) *VisitorLogUpdateOne {
	mutation := newVisitorLogMutation(c.config, OpUpdateOne, withVisitorLog(vl))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *VisitorLogClient) DeleteOne(vl *VisitorLog) *VisitorLogDeleteOne {
...
// UpdateOne returns an update builder for the given entity.
func (c *VisitorStatClient) UpdateOne(vs *VisitorStat) *VisitorStatUpdateOne {
	mutation := newVisitorStatMutation(c.config, OpUpdateOne, withVisitorStat(vs))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *VisitorStatClient) DeleteOne(vs *VisitorStat) *VisitorStatDeleteOne {
...
type (
	hooks struct {
		Album, AlbumCategory, Article, ArticleHistory, ArticlePayment, ArticlePurchase,
		Comment, DirectLink, DocSeries, Entity, File, FileEntity, Link, LinkCategory,
		LinkTag, Metadata, NotificationType, Page, PostCategory, PostTag, Setting,
