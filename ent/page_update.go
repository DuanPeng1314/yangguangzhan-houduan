...
func (pu *PageUpdate) SetCustomJs(s string) *PageUpdate {
	pu.mutation.SetCustomJs(s)
	return pu
}

// SetNillableCustomJs sets the "custom_js" field if the given value is not nil.
func (pu *PageUpdate) SetNillableCustomJs(s *string) *PageUpdate {
	if s != nil {
		pu.SetCustomJs(*s)
	}
	return pu
...
func (pu *PageUpdate) SetCustomCSS(s string) *PageUpdate {
	pu.mutation.SetCustomCSS(s)
	return pu
}

// SetNillableCustomCSS sets the "custom_css" field if the given value is not nil.
func (pu *PageUpdate) SetNillableCustomCSS(s *string) *PageUpdate {
	if s != nil {
		pu.SetCustomCSS(*s)
	}
	return pu
...
func (pu *PageUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.CustomJs(); ok {
		_spec.SetField(page.FieldCustomJs, field.TypeString, value)
	}
	if value, ok := pu.mutation.CustomCSS(); ok {
...
// SetCustomJs sets the "custom_js" field.
func (puo *PageUpdateOne) SetCustomJs(s string) *PageUpdateOne {
	puo.mutation.SetCustomJs(s)
	return puo
}

// SetNillableCustomJs sets the "custom_js" field if the given value is not nil.
func (puo *PageUpdateOne) SetNillableCustomJs(s *string) *PageUpdateOne {
	if s != nil {
		puo.SetCustomJs(*s)
	}
	return puo
...
// SetCustomCSS sets the "custom_css" field.
func (puo *PageUpdateOne) SetCustomCSS(s string) *PageUpdateOne {
	puo.mutation.SetCustomCSS(s)
	return puo
}

// SetNillableCustomCSS sets the "custom_css" field if the given value is not nil.
func (puo *PageUpdateOne) SetNillableCustomCSS(s *string) *PageUpdateOne {
	if s != nil {
		puo.SetCustomCSS(*s)
	}
	return puo
...
func (puo *PageUpdateOne) sqlSave(ctx context.Context) (_node *Page, err error) {
	...
	if value, ok := puo.mutation.CustomJs(); ok {
		_spec.SetField(page.FieldCustomJs, field.TypeString, value)
	}
	if value, ok := puo.mutation.CustomCSS(); ok {
		_spec.SetField(page.FieldCustomCSS, field.TypeString, value)
	}
